...
const LANG_COLORS: Record<string, { color: string; bg: string; accent: string }> = {
...
const DIFF_CONFIG: Record<string, { color: string; bg: string; dot: string }> = {
...
export default function LessonsPage() {
    ...
    const langConf = (l: string) => LANG_COLORS[l?.toLowerCase()] ?? { color: "#6366f1", bg: "#eef2ff", accent: "#6366f1" };
    const diffConf = (d: string) => DIFF_CONFIG[d?.toLowerCase()] ?? { color: "#6b7280", bg: "#f9fafb", dot: "#9ca3af" };
